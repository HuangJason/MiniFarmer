...
- (void)initNoanswerView{
    if (_commonView) {
        _noanswerView =[[UIView alloc] initWithFrame:CGRectMake(0, _commonView.bottom+kNavigationBarHeight+kStatusBarHeight+8, kScreenSizeWidth, kScreenSizeHeight-_commonView.bottom)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (ansItem.fdzp!= nil||ansItem.relist.count!= 0) {
        myHeader = nil;
    }
